...
# MarkdownReader vendors the core parser only. Optional upstream plugins are
# added individually when a product feature requires them.
html: Markdown = create_markdown(escape=False)
